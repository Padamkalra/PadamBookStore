...
at 9:47am I added a new interface in IReposiorty file named as UnitOfWork.cs
 ...
 I am finally done with part the ENTIRE PART 2  HAHA:)
  ...
  In Models/Product.cs I added three more properties of price -
   ...
   3:33 pm
   I added these propersties in Utility/SD.cs file added the differences
 ...
 3:45pm 
 In Product/Upsert.cshtml file I  added the  fields for the new properties to enter-
	...
	4:10pm
	In Index.cshtml file I made changes  to display product on the home page of the application and made changes to match the given file
